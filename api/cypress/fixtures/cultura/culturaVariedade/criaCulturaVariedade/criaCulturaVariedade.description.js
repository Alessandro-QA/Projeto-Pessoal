const html = {
    Ct1: `
      ...
      <div>
        ...
        <span style="color: black;">Este teste faz uma requisição do tipo 'post', criando uma nova Variedade com descrição, nome científico e demais informações e valida se após a criação cada informação é do tipo esperado.</span>
      </div>
    `,
    Ct2: `
      <div>
