const html = {
  Ct1: `
    <div>
      ...
      <span style="color: black;">A rota POST de ReadXMLParaguai permite o envio de um arquivo XML paraguaio para carregamento dos dados de forma automática.</span>
    </div>
    <br/>
    <div>
