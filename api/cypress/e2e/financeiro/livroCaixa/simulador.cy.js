...
context('Financeiro', () => {
    context('Livro Caixa', () => {
        describe('GET - /api/financeiro/v1/LivroCaixa/Simulador - Obtém simulação anual de Registro do Livro Caixa', () => {
            it('CT1 - Deve simular registro do Livro Caixa', () => {
                cy.fixture('financeiro/livroCaixa/simulador/paramsCt1.json').then((params) => {
                    cy.getRequestWhitParams('/api/financeiro/v1/LivroCaixa/Simulador', params)
                        .then((response) => {
