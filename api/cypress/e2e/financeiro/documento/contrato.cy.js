...
context('Financeiro', () => {
    context('Documento', () => {
        describe(`GET - ${Cypress.env('financeiro')}/v1/Documento/Contrato/{id} - Obtém Dados do Contrato e os Recebimentos Financeiros Relacionados a ele pelo ID`, () => {
            it('CT1 - Obtém Dados do Contrato e os Recebimentos Financeiros Relacionados a ele pelo ID', () => {
                cy.getRequest(`${Cypress.env('baseUrl')}${Cypress.env('financeiro')}/Documento/Contrato/3acf724f-1814-4676-aad2-985e398d86ec`)
                    .then((response) => {
