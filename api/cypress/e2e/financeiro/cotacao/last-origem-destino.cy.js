...
context('Financeiro', () => {
    context('Cotacao', () => {
        describe('GET - /api/financeiro/v1/cotacao/last/origem/{MoedaIdOrigem}/Destino/{MoedaIdDestino} - Obtém Dados das duas moedas envolvidas na conversao/cotacao', () => {
            ...
            it('CT1 - Obtém Dados das duas moedas envolvidas na conversao/cotacao', () => {
                cy.fixture('financeiro/cotacao/paramsCt1.json').then((params) => {
                    cy.getRequestWhitParams(`/api/financeiro/v1/cotacao/last/origem/${params.MoedaIdOrigem}/destino/${params.MoedaIdDestino}`, params)
                        .then((response) => {
