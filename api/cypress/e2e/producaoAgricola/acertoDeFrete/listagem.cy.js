    ...
    context('Listagem - POST - /api/producao-agricola/v1/AcertoFretes/List', () => {
        describe('Filtragem de cabeçalho', () => {
            it('CT1 - Deve trazer 20 resultados sem filtro', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.semFiltro)
                    .then((response) => {
            ...
            it('CT2 - Deve trazer 2 resultados sem filtro', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.semFiltro2Resultados)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT3 - Deve filtrar por motorista', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porMotorista)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT4 - Deve filtrar por placa', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porPlaca)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
        ...
        describe('Filtragem funil', () => {
            it('CT1 - Deve filtrar por periodo', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porPeriodo)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
                        expect(response.body).to.have.lengthOf(20).to.be.not.null
            ...
            it('CT2 - Deve filtrar por Origem - Unidade Armazenamento', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porOrigemUA)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT3 - Deve filtrar por Origem - Cliente', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porOrigemCliente)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT4 - Deve filtrar por Destino - Unidade Armazenamento', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porDestinoUA)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
                        expect(response.body).to.have.lengthOf(2).to.be.not.null
            ...
            it('CT5 - Deve filtrar por Destino - Cliente', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porDestinoCliente)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT6 - Deve filtrar por Safra', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porSafra)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
                        expect(response.body).to.have.lengthOf(20).to.be.not.null
            ...
            it('CT7 - Deve filtrar por Fazenda', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porFazenda)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
                        expect(response.body).to.have.lengthOf(20).to.be.not.null
            ...
            it('CT8 - Deve filtrar por Status - Liquidado', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porStatusLiquidado)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT9 - Deve filtrar por Status - Pendente', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porStatusPendente)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
            ...
            it('CT10 - Deve filtrar por Status - Acertado', () => {
                cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porStatusAcertado)
                    .then((response) => {
                        expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                        expect(response.status).to.equal(200)
                        expect(response.body).to.have.lengthOf(5).to.be.not.null
        ...
        describe.skip('Filtragem por pequisa', () => {
            it('CT1 - Deve filtrar por palavra', () => {
                cy.fixture('producaoAgricola/acertoDeFrete/listagem/funil/bodyCt4').then((body) => {
                    cy.executeRequest('POST', '/api/producao-agricola/v1/AcertoFretes/List', seedTeste.porPalavra)
                        .then((response) => {
                            expect(response.requestHeaders).to.have.property('x-tenant').to.be.equal('273276e0-7cc1-4891-94de-55e9ced2aad2')
                            expect(response.status).to.equal(200)
                            expect(response.body).to.have.lengthOf(11).to.be.not.null
