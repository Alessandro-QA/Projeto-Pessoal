...
const description = require('../../../fixtures/safra/getSafra/getSafra.description')
...
context('Safra', () => {
    context('Consulta de Safra', () => {
        ...
        describe(`GET - ${Cypress.env('safra')}/Safra - Listar Safras`, () => {
            ...
            // No aguardo da migração da Rota
            it.skip('CT3 - Deve Trazer a Safra filtrada pela Descrição', () => {
