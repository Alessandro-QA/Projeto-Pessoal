...
const description = require('../../../fixtures/pedidoCompra/recebimento/readXml/readXml.description');
    ...
    context('Recebimento', () => {
        describe(`POST - ${Cypress.env('pedidoCompra')}/Recebimentos/ReadXml - Realiza o Recebimento Automático via Importação de Arquivo XML`, () => {
            ...
            it('CT1 - Carregar XML Brasileiro para validação dos dados carregados automaticamente', () => {
                ...
                cy.readFile('cypress/fixtures/pedidoCompra/recebimento/readXml/XML_BR.xml', 'utf8').then(xmlContent => {
                    ...
                    cy.request({
                        ...
                        cy.readFile('cypress/fixtures/pedidoCompra/recebimento/readXml/bodyCt1.json').then((body) => {
