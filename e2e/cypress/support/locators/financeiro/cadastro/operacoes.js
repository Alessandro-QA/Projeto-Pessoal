const locators = {
  listagem: {
    ...
    listTipoOperacao:'[data-cy="select-tipo-operacao"] > .list > .list__items',
    tipoOperacaoSelecionado: '[data-cy=select-tipo-operacao] .selected',
    listFinalidadeOperacao: '[data-cy=select-finalidade-operacao] > .list > .list__items',
    ...
    listMovimentaFinanceiro: '[data-cy=select-movimenta-financeiro] > .list > .list__items',
    movimentaFinanceiroSelecionado: '[data-cy=select-movimenta-financeiro] .selected',
    selectStatus: '[data-cy=select-status]',
    listStatus: '[data-cy=select-status] > .list > .list__items',
