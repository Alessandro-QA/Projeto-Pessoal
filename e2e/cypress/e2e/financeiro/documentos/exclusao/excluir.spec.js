    ...
    context('Exclusão', () => {
      context('Documento conferido e não conferido', () => {
        ...
        it('Não conferido', function () {
          // cy.allure().severity('critical').startStep('test content').descriptionHtml(testDescription.naoConferido);

          // Exemplo de como adicionar descrição no Cypress corretamente:
          cy.allure()
            .severity('critical')
            .startStep('test content')
        ...
        it('Conferido', function () {
          // cy.allure().severity('critical').startStep('test content').descriptionHtml(testDescription.conferido);
