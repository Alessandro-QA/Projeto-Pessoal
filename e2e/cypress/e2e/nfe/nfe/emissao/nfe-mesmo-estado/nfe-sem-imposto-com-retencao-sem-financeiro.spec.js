...
import seedTestNfe from '../../../../../fixtures/nfe/nfe/emissao/nfe-mesmo-estado/nfe-sem-imposto-com-retencao-sem-financeiro.json'
...
describe('NF-e', { tags: '@nfe' }, () => {
  ...
  describe('NF-e', { tags: '@nfe' }, () => {
    describe('Emissão', () => {
      context('Sem imposto, com retenção, sem financeiro', () => {
