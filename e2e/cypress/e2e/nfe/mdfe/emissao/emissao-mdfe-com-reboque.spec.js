...
import seedTestMdfe from '../../../../fixtures/nfe/mdfe/emissao/emissao-mdfe-com-reboque.json'
...
describe('MDF-e', { tags: '@mdfe' }, () => {
  ...
  describe('MDF-e', { tags: '@mdfe' }, () => {
    describe('Emissão', () => {
      context('MDF-e com carregamento e descarregamento no mesmo estado (Com Reboque)', () => {
