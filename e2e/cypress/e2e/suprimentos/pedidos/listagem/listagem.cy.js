    ...
    describe('Pedidos', { tags: '@pedidos' }, () => {
        describe('Listagem', { tags: '@listagem' }, () => {
            ...
            context('Listagem de Pedidos - Validação dos filtros', () => {
                ...
                it('Deve Listar todos os Pedidos Sem Filtro', { retries: { runMode: 1, openMode: 1, }, }, function () {
                    cy.allureDescriptionHtml(testDescription.listagemSemFiltro).allureSeverity('normal')
                    Pedidos.listagem(seedTest.semFiltro)
                })

                it('Deve Listar os Pedidos filtrados por Safra', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Listar os Pedidos filtrados por Fazenda', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Listar os Pedidos filtrados por Empresa', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Fazer uma Busca por String Entre os Pedidos', { retries: { runMode: 1, openMode: 1, }, }, function () {
                    cy.allureDescriptionHtml(testDescription.buscaPorString).allureSeverity('normal')
                    Pedidos.listagem(seedTest.pesquisa)
                })

                it('Deve Listar os Pedidos filtrados por Data', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Listar os Pedidos filtrados por Fornecedor', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Listar os Pedidos filtrados por Status', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Deve Listar os Pedidos filtrados por Múltiplos Filtros', { retries: { runMode: 1, openMode: 1, }, }, function () {
                ...
                it('Validar Mensagem de Nenhum Pedido Encontrado', { retries: { runMode: 1, openMode: 1, }, }, function () {
