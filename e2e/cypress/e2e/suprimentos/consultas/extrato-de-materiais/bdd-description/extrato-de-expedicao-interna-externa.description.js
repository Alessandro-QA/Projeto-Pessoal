...
<div>
    ...
    <span style="color: #b22222;"> Consulta de extrato de material para Expedição Interna x Externa, após colheita </span>
</div>
<div style="margin-left: 40px;">
    <strong>DADO</strong> a inclusão de uma colheita interna para a U.A do tipo silo <br/>
    <strong>QUANDO</strong> for realizado a expedição do tipo Interno X Externo (de UA para outra fazenda/pessoa) <br/>
    <strong>ENTAO</strong> no extrato de materiais da UA de origem deve conter dois lançamentos de origem Armazenagem e tipo Entrada e Saída com os valores colhidos e expedidos <br/>
    <strong>E</strong> no dashboard de produção, na tabela de Entregas e Fixações, deve conter um registro paro cliente de destino com os valores recebidos <br/>
