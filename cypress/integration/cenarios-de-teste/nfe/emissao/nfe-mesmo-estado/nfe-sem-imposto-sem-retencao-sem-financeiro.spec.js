...
import seedTestNfe from '../../../../../fixtures/cenarios-de-teste/nfe/emissao/nfe-mesmo-estado/nfe-sem-imposto-sem-retencao-sem-financeiro.json'
import Nfe from '../../../../../support/commands/funcionalidades/nfe/nfe.js'

describe('FUNCIONALIDADE > NFe | Emissão de NFe: sem imposto, sem retenção, sem financeiro - ', { tags: '@nfe' }, () => {
  before(function () {
