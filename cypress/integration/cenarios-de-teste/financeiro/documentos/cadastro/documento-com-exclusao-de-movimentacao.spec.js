...
import Safra from '../../../../../support/commands/funcionalidades/resultados-safra/resultado-safra.js'
...
describe('CENÁRIO > Documentos | Cadastro de documento com exclusão de movimentação - ', { tags: '@documentos' }, () => {
  ...
  it('Validar resultado da safra - Dashboard', function () {
    ...
    Safra.validarDashboard(seedTestResultadoSafra.resultadoDaSafraDashboard)
  })

  it('Validar resultado da safra - Analítica', function () {
    cy.allure().severity('normal').startStep('test content')

    Safra.resultadoAnalitico(seedTestResultadoSafra.resultadoDaSafraAnalitica)
  })
  ...
  it('Validar se exclusão refletiu no resultado da safra - Dashboard', function () {
    ...
    Safra.validarDashboard(seedTestResultadoSafra.exclusaoResultadoDaSafraDashboard)
  })
