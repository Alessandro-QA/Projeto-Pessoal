...
/*
* Funcionalidade:
*   Cadastro de colheita externa
* Cenario:
*   Dado que eu queira incluir um registro de colheita
*   Quando eu preencher todos os campos obrigatórios, selecionar destino "Externo" e clicar no botão salvar
...
describe('FUNCIONALIDADE > Colheitas | Cadastro de colheita externa sem contrato com desconto - ', { tags: '@colheita' }, () => {
  before(function () {
